...
*gatus*)
    ...
    printf 'PIHOLE_1_INTERNAL__PROMETHEUS_PASSWORD=%s\n' "$(load_token pihole-1-internal app prometheus)" >>"$initial_output/app.env"
    ...
    printf 'PIHOLE_2_INTERNAL__PROMETHEUS_PASSWORD=%s\n' "$(load_token pihole-2-internal app prometheus)" >>"$initial_output/app.env"
    ...
    printf 'PIHOLE_1_INTERNAL__PROXY_PROMETHEUS_PASSWORD=%s\n' "$(load_token pihole-1-internal apache prometheus)" >>"$initial_output/app.env"
    ...
    printf 'PIHOLE_2_INTERNAL__PROXY_PROMETHEUS_PASSWORD=%s\n' "$(load_token pihole-2-internal apache prometheus)" >>"$initial_output/app.env"
...
*homepage*)
    ...
    printf 'HOMEPAGE_VAR__PIHOLE_1_INTERNAL__PASSWORD=%s\n' "$(load_token pihole-1-internal app admin)" >>"$initial_output/app.env"
    ...
    printf 'HOMEPAGE_VAR__PIHOLE_2_INTERNAL__PASSWORD=%s\n' "$(load_token pihole-2-internal app admin)" >>"$initial_output/app.env"
