...
(async () => {
    ...
    const certificatorHealthchecks = [
        ...
        'MotionEye - Kitchen',
        'Netalertx',
        // 'NodeExporter - MacBook Pro 2012',
        'NodeExporter - Odroid H3',
        'NodeExporter - Odroid H4 Ultra',
        // 'NodeExporter - Raspberry Pi 3B',
        'NodeExporter - Raspberry Pi 4B 2GB',
        'NodeExporter - Raspberry Pi 4B 4GB',
        'Ntfy',
        'Ollama',
        'Ollama [private]',
        'OmadaController',
