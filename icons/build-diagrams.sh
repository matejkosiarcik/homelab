...
convert_image_full "$input_dir/gitman-repositories/dashboard-icons/svg/rabbitmq.svg" "$output_dir/rabbitmq.png"
...
convert_image_full "$input_dir/other/reportportal.svg.bin" "$output_dir/reportportal.png"
