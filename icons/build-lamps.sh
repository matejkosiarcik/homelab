...
# ICO
convert_file "magick INPUT_FILE -resize 16x16 -density 1200 -background none -bordercolor transparent OUTPUT_FILE" "$tmpdir/13_05_osa_icons_svg/osa_awareness.svg" "$tmpdir/favicon-16.png"
convert_file "magick INPUT_FILE -resize 32x32 -density 1200 -background none -bordercolor transparent OUTPUT_FILE" "$tmpdir/13_05_osa_icons_svg/osa_awareness.svg" "$tmpdir/favicon-32.png"
convert_file "magick INPUT_FILE -resize 48x48 -density 1200 -background none -bordercolor transparent OUTPUT_FILE" "$tmpdir/13_05_osa_icons_svg/osa_awareness.svg" "$tmpdir/favicon-48.png"
