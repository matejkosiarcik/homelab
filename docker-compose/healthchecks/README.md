...
- Docs:
    - General: <https://healthchecks.io/docs/self_hosted_docker>
    - Server configuration: <https://healthchecks.io/docs/self_hosted_configuration>
    - Running in Docker: <https://healthchecks.io/docs/self_hosted_docker>
