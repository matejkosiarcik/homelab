...
cat </homelab/prometheus.yml |
    ...
    sed "s~\${UPTIMEKUMA_1_PROMETHEUS_PASSWORD}~$UPTIMEKUMA_1_PROMETHEUS_PASSWORD~g" |
    sed "s~\${UPTIMEKUMA_2_PROMETHEUS_PASSWORD}~$UPTIMEKUMA_2_PROMETHEUS_PASSWORD~g" |
    sed "s~\${UPTIMEKUMA_1_PROXY_PROMETHEUS_PASSWORD}~$UPTIMEKUMA_1_PROXY_PROMETHEUS_PASSWORD~g" |
    sed "s~\${UPTIMEKUMA_2_PROXY_PROMETHEUS_PASSWORD}~$UPTIMEKUMA_2_PROXY_PROMETHEUS_PASSWORD~g" |
