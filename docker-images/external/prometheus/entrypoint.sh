...
cat </etc/prometheus/prometheus.yml |
    sed "s~\${GATUS_1_PASSWORD}~$GATUS_1_PASSWORD~g" |
    sed "s~\${GATUS_2_PASSWORD}~$GATUS_2_PASSWORD~g" |
    sed "s~\${GLANCES_ODROID_H3_PASSWORD}~$GLANCES_ODROID_H3_PASSWORD~g" |
    sed "s~\${GLANCES_RASPBERRY_PI_3B_PASSWORD}~$GLANCES_RASPBERRY_PI_3B_PASSWORD~g" |
    sed "s~\${GLANCES_RASPBERRY_PI_4B_2G_PASSWORD}~$GLANCES_RASPBERRY_PI_4B_2G_PASSWORD~g" |
    sed "s~\${GLANCES_RASPBERRY_PI_4B_4G_PASSWORD}~$GLANCES_RASPBERRY_PI_4B_4G_PASSWORD~g" |
    sed "s~\${HOMEASSISTANT_TOKEN}~$HOMEASSISTANT_TOKEN~g;s~\${MINIO_TOKEN}~$MINIO_TOKEN~g" |
    sed "s~\${PIHOLE_1_PRIMARY_PASSWORD}~$PIHOLE_1_PRIMARY_PASSWORD~g" |
    sed "s~\${PIHOLE_1_SECONDARY_PASSWORD}~$PIHOLE_1_SECONDARY_PASSWORD~g" |
    sed "s~\${PIHOLE_2_PRIMARY_PASSWORD}~$PIHOLE_2_PRIMARY_PASSWORD~g" |
    sed "s~\${PIHOLE_2_SECONDARY_PASSWORD}~$PIHOLE_2_SECONDARY_PASSWORD~g" |
    ...
    sed "s~\${MOTIONEYE_STOVE_PROXY_PROMETHEUS_PASSWORD}~$MOTIONEYE_STOVE_PROXY_PROMETHEUS_PASSWORD~g" |
