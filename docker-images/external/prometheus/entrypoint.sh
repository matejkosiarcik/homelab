...
cat </homelab/prometheus.yml |
    ...
    sed "s~\${UNBOUND_1_BLACKHOLE__PROMETHEUS_PASSWORD}~$UNBOUND_1_BLACKHOLE__PROMETHEUS_PASSWORD~g" |
    sed "s~\${UNBOUND_1_BLACKHOLE__PROXY_PROMETHEUS_PASSWORD}~$UNBOUND_1_BLACKHOLE__PROXY_PROMETHEUS_PASSWORD~g" |
    ...
    sed "s~\${UNBOUND_2_BLACKHOLE__PROMETHEUS_PASSWORD}~$UNBOUND_2_BLACKHOLE__PROMETHEUS_PASSWORD~g" |
    sed "s~\${UNBOUND_2_BLACKHOLE__PROXY_PROMETHEUS_PASSWORD}~$UNBOUND_2_BLACKHOLE__PROXY_PROMETHEUS_PASSWORD~g" |
