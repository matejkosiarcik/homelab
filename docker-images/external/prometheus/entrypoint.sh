...
cat </homelab/prometheus.yml |
    ...
    sed "s~\${DAWARICH_PROXY_PROMETHEUS_PASSWORD}~$DAWARICH_PROXY_PROMETHEUS_PASSWORD~g" |
    ...
    sed "s~\${HOMEASSISTANT_PROMETHEUS_TOKEN}~$HOMEASSISTANT_PROMETHEUS_TOKEN~g" |
    sed "s~\${HOMEASSISTANT_PROXY_PROMETHEUS_PASSWORD}~$HOMEASSISTANT_PROXY_PROMETHEUS_PASSWORD~g" |
    ...
    sed "s~\${NODEEXPORTER_ODROID_H3_PROMETHEUS_PASSWORD}~$NODEEXPORTER_ODROID_H3_PROMETHEUS_PASSWORD~g" |
    sed "s~\${NODEEXPORTER_ODROID_H3_PROXY_PROMETHEUS_PASSWORD}~$NODEEXPORTER_ODROID_H3_PROXY_PROMETHEUS_PASSWORD~g" |
    sed "s~\${NODEEXPORTER_ODROID_H4_ULTRA_PROMETHEUS_PASSWORD}~$NODEEXPORTER_ODROID_H4_ULTRA_PROMETHEUS_PASSWORD~g" |
    sed "s~\${NODEEXPORTER_ODROID_H4_ULTRA_PROXY_PROMETHEUS_PASSWORD}~$NODEEXPORTER_ODROID_H4_ULTRA_PROXY_PROMETHEUS_PASSWORD~g" |
    sed "s~\${NODEEXPORTER_RASPBERRY_PI_3B_PROMETHEUS_PASSWORD}~$NODEEXPORTER_RASPBERRY_PI_3B_PROMETHEUS_PASSWORD~g" |
    sed "s~\${NODEEXPORTER_RASPBERRY_PI_3B_PROXY_PROMETHEUS_PASSWORD}~$NODEEXPORTER_RASPBERRY_PI_3B_PROXY_PROMETHEUS_PASSWORD~g" |
    sed "s~\${NODEEXPORTER_RASPBERRY_PI_4B_2G_PROMETHEUS_PASSWORD}~$NODEEXPORTER_RASPBERRY_PI_4B_2G_PROMETHEUS_PASSWORD~g" |
    sed "s~\${NODEEXPORTER_RASPBERRY_PI_4B_2G_PROXY_PROMETHEUS_PASSWORD}~$NODEEXPORTER_RASPBERRY_PI_4B_2G_PROXY_PROMETHEUS_PASSWORD~g" |
    sed "s~\${NODEEXPORTER_RASPBERRY_PI_4B_4G_PROMETHEUS_PASSWORD}~$NODEEXPORTER_RASPBERRY_PI_4B_4G_PROMETHEUS_PASSWORD~g" |
    sed "s~\${NODEEXPORTER_RASPBERRY_PI_4B_4G_PROXY_PROMETHEUS_PASSWORD}~$NODEEXPORTER_RASPBERRY_PI_4B_4G_PROXY_PROMETHEUS_PASSWORD~g" |
    ...
    sed "s~\${OMADACONTROLLER_PROXY_PROMETHEUS_PASSWORD}~$OMADACONTROLLER_PROXY_PROMETHEUS_PASSWORD~g" |
    ...
    sed "s~\${RENOVATEBOT_PROXY_PROMETHEUS_PASSWORD}~$RENOVATEBOT_PROXY_PROMETHEUS_PASSWORD~g" |
    ...
    sed "s~\${UNBOUND_1_DEFAULT_PROMETHEUS_PASSWORD}~$UNBOUND_1_DEFAULT_PROMETHEUS_PASSWORD~g" |
    sed "s~\${UNBOUND_1_DEFAULT_PROXY_PROMETHEUS_PASSWORD}~$UNBOUND_1_DEFAULT_PROXY_PROMETHEUS_PASSWORD~g" |
    sed "s~\${UNBOUND_1_GUESTS_PROMETHEUS_PASSWORD}~$UNBOUND_1_GUESTS_PROMETHEUS_PASSWORD~g" |
    sed "s~\${UNBOUND_1_GUESTS_PROXY_PROMETHEUS_PASSWORD}~$UNBOUND_1_GUESTS_PROXY_PROMETHEUS_PASSWORD~g" |
    sed "s~\${UNBOUND_1_IOT_PROMETHEUS_PASSWORD}~$UNBOUND_1_IOT_PROMETHEUS_PASSWORD~g" |
    sed "s~\${UNBOUND_1_IOT_PROXY_PROMETHEUS_PASSWORD}~$UNBOUND_1_IOT_PROXY_PROMETHEUS_PASSWORD~g" |
    sed "s~\${UNBOUND_1_MATEJ_PROMETHEUS_PASSWORD}~$UNBOUND_1_MATEJ_PROMETHEUS_PASSWORD~g" |
    sed "s~\${UNBOUND_1_MATEJ_PROXY_PROMETHEUS_PASSWORD}~$UNBOUND_1_MATEJ_PROXY_PROMETHEUS_PASSWORD~g" |
    sed "s~\${UNBOUND_1_MONIKA_PROMETHEUS_PASSWORD}~$UNBOUND_1_MONIKA_PROMETHEUS_PASSWORD~g" |
    sed "s~\${UNBOUND_1_MONIKA_PROXY_PROMETHEUS_PASSWORD}~$UNBOUND_1_MONIKA_PROXY_PROMETHEUS_PASSWORD~g" |
    sed "s~\${UNBOUND_2_DEFAULT_PROMETHEUS_PASSWORD}~$UNBOUND_2_DEFAULT_PROMETHEUS_PASSWORD~g" |
    sed "s~\${UNBOUND_2_DEFAULT_PROXY_PROMETHEUS_PASSWORD}~$UNBOUND_2_DEFAULT_PROXY_PROMETHEUS_PASSWORD~g" |
    sed "s~\${UNBOUND_2_GUESTS_PROMETHEUS_PASSWORD}~$UNBOUND_2_GUESTS_PROMETHEUS_PASSWORD~g" |
    sed "s~\${UNBOUND_2_GUESTS_PROXY_PROMETHEUS_PASSWORD}~$UNBOUND_2_GUESTS_PROXY_PROMETHEUS_PASSWORD~g" |
    sed "s~\${UNBOUND_2_IOT_PROMETHEUS_PASSWORD}~$UNBOUND_2_IOT_PROMETHEUS_PASSWORD~g" |
    sed "s~\${UNBOUND_2_IOT_PROXY_PROMETHEUS_PASSWORD}~$UNBOUND_2_IOT_PROXY_PROMETHEUS_PASSWORD~g" |
    sed "s~\${UNBOUND_2_MATEJ_PROMETHEUS_PASSWORD}~$UNBOUND_2_MATEJ_PROMETHEUS_PASSWORD~g" |
    sed "s~\${UNBOUND_2_MATEJ_PROXY_PROMETHEUS_PASSWORD}~$UNBOUND_2_MATEJ_PROXY_PROMETHEUS_PASSWORD~g" |
    sed "s~\${UNBOUND_2_MONIKA_PROMETHEUS_PASSWORD}~$UNBOUND_2_MONIKA_PROMETHEUS_PASSWORD~g" |
    sed "s~\${UNBOUND_2_MONIKA_PROXY_PROMETHEUS_PASSWORD}~$UNBOUND_2_MONIKA_PROXY_PROMETHEUS_PASSWORD~g" |
    sed "s~\${UNIFICONTROLLER_PROXY_PROMETHEUS_PASSWORD}~$UNIFICONTROLLER_PROXY_PROMETHEUS_PASSWORD~g" |
    sed "s~\${UPTIMEKUMA_PROMETHEUS_PASSWORD}~$UPTIMEKUMA_PROMETHEUS_PASSWORD~g" |
    sed "s~\${UPTIMEKUMA_PROXY_PROMETHEUS_PASSWORD}~$UPTIMEKUMA_PROXY_PROMETHEUS_PASSWORD~g" |
