...
# Set PROXY_UPSTREAM_URL_OWNTRACKS_DECRYPTOR
if [ "$HOMELAB_APP_TYPE" = 'owntracks' ]; then
    PROXY_UPSTREAM_URL_OWNTRACKS_DECRYPTOR='http://decryptor:8080'
else
    PROXY_UPSTREAM_URL_OWNTRACKS_DECRYPTOR=''
fi
export PROXY_UPSTREAM_URL_OWNTRACKS_DECRYPTOR
printf "export PROXY_UPSTREAM_URL_OWNTRACKS_DECRYPTOR='%s'\n" "$PROXY_UPSTREAM_URL_OWNTRACKS_DECRYPTOR" >>/etc/apache2/envvars
