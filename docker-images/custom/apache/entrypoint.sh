...
elif [ "$HOMELAB_APP_TYPE" = 'docker-cache' ]; then
...
elif [ "$HOMELAB_APP_TYPE" = 'donetick' ]; then
    PROXY_UPSTREAM_URL='http://app:2021'
elif [ "$HOMELAB_APP_TYPE" = 'filebrowser' ]; then
    PROXY_UPSTREAM_URL='http://app:80'
elif [ "$HOMELAB_APP_TYPE" = 'gatus' ]; then
    PROXY_UPSTREAM_URL='http://app:8080'
elif [ "$HOMELAB_APP_TYPE" = 'git-cache' ]; then
    PROXY_UPSTREAM_URL='http://app:8080'
...
#     PROXY_UPSTREAM_URL='http://app:61208'
    ...
    PROXY_UPSTREAM_URL='http://app:8080'
elif [ "$HOMELAB_APP_TYPE" = 'koffan' ]; then
    PROXY_UPSTREAM_URL='http://app:8080'
elif [ "$HOMELAB_APP_TYPE" = 'libretranslate' ]; then
    PROXY_UPSTREAM_URL='http://app:5000'
    ...
    PROXY_UPSTREAM_URL='http://app'
elif [ "$HOMELAB_APP_TYPE" = 'planka' ]; then
    PROXY_UPSTREAM_URL='http://app:1337'
elif [ "$HOMELAB_APP_TYPE" = 'prometheus' ]; then
    PROXY_UPSTREAM_URL='http://app:9090'
elif [ "$HOMELAB_APP_TYPE" = 'renovatebot' ]; then
    PROXY_UPSTREAM_URL='http://app:8080'
elif [ "$HOMELAB_APP_TYPE" = 'reportportal' ]; then
    PROXY_UPSTREAM_URL='http://app-index:8080'
