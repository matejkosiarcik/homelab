...
DOCKER_COMPONENTS := $(shell printf '.shared/socat .shared/proxy .shared/ui-backup .shared/lamps/hardware-controller .shared/lamps/network-server machines/odroid-h3/healthchecks/db-backup' | sed 's~ ~\n~g')
