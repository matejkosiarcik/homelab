...
*gatus*)
    ...
    printf 'GATUS_1_PROXY_PROMETHEUS_PASSWORD=%s\n' "$(load_token gatus http-proxy prometheus)" >>"$output/gatus.env"
    ...
    printf 'GLANCES_RASPBERRY_PI_3B_PROXY_PROMETHEUS_PASSWORD=%s\n' "$(load_token glances--raspberry-pi-3b http-proxy prometheus)" >>"$output/gatus.env"
...
*prometheus*)
    ...
    printf 'GATUS_1_PROXY_PROMETHEUS_PASSWORD=%s\n' "$(load_token gatus http-proxy prometheus)" >>"$output/prometheus.env"
