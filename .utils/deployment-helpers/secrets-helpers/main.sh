...
*homepage*)
    ...
    printf 'HOMEPAGE_VAR_HOMEASSISTANT_APIKEY=%s\n' "$(load_token homeassistant app homepage-api-key)" >>"$output/app.env"
    ...
    printf 'HOMEPAGE_VAR_PIHOLE_1_PRIMARY_APIKEY=%s\n' "$(load_token pihole-1-primary app api-key)" >>"$output/app.env"
    printf 'HOMEPAGE_VAR_PIHOLE_1_SECONDARY_APIKEY=%s\n' "$(load_token pihole-1-secondary app api-key)" >>"$output/app.env"
    printf 'HOMEPAGE_VAR_PIHOLE_2_PRIMARY_APIKEY=%s\n' "$(load_token pihole-2-primary app api-key)" >>"$output/app.env"
    printf 'HOMEPAGE_VAR_PIHOLE_2_SECONDARY_APIKEY=%s\n' "$(load_token pihole-2-secondary app api-key)" >>"$output/app.env"
